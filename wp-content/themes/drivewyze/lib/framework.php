<?php
/**
 * Various functions required for drivewyze-bootstrap to work properly
 *
 * @package Drivewyze
 */
...
/**
 * drivewyze_navwalker class
 * Menu navigation walker
 * Class Name: drivewyze_navwalker
 * GitHub URI: https://github.com/twittem/wp-drivewyze-navwalker
 * Description: A custom WordPress nav walker class to implement the drivewyze 3 navigation style in a custom theme using the WordPress built in menu manager.
 */
...
/**
 * Pagination
 * Custom pagination with drivewyze .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-drivewyze/
 *
 * @param boolean $echo echo
 * @return string
 */
function drivewyze_pagination( $echo = true ) {
	global $wp_query;
