...
if ( ! class_exists( 'Drivewyze_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * Drivewyze_Protocol_Relative_Theme_Assets class
	 */
	class Drivewyze_Protocol_Relative_Theme_Assets {
		/**
	...
	$drivewyze_protocol_relative_theme_assets = new Drivewyze_Protocol_Relative_Theme_Assets();
endif;
