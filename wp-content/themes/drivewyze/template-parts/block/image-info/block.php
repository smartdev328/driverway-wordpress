...
?>
<section id="<?php echo $block_id; ?>" class="image-info-block <?php echo $slug; ?> <?php echo $align_class; ?> <?php echo $custom_class; ?>" <?php echo $bl_bg; ?>
					...
					<div class="image-info-block-info subtitle">
						...
						<div class="image-info-block__wrap">
							...
							<?php if ( ! empty( $bl_link ) && is_array( $bl_link ) ) : ?>
								<a class="image-info-link" href="<?php echo $bl_link['url']; ?>" target="<?php echo $bl_link['target']; ?>">
